-- Imported helper functions from upstream intl.lua
local locale = {}
local cache = {}
...
ulang = {
	...
	_cm_ushot = 'Screenshot (with subtitles, no OSD)',
	_cm_video = 'Video',
	...
	_cm_tools = 'Tools',
	_cm_keybinding = '※ Key Bindings List',
	...
	_cm_show_file_dir = '※ Open Current File Location',
	...
	_import_id_footnote = 'Paste a URL to load directly. Ctrl+V. Go to parent folder: Alt+UP',
...
--	_menu_item_empty_title = 'Empty',
	...
	_sid_submenu_label1 = 'Toggle Secondary Subs',
...
--	_sid_sec_submenu_title = 'Secondary Subtitle Track List',
	...
	_xid_submenu_footnote = 'Click an entry again to disable it. Paste a URL to add directly: Ctrl+V',
	_playlist_submenu_title = 'Playlist',
	_playlist_submenu_footnote = 'Paste a URL to add directly: Ctrl+V. Reorder: Ctrl+UP/DOWN/PGUP/PGDWN/HOME/END',
...
--	_dlsub_fin2 = 'Load subtitles',
	_dlsub_remain = 'Downloads remaining today',
	_dlsub_reset = 'Reset',
...
--	_submenu_id_disabled = 'Disabled',
	...
	_submenu_file_browser_label2 = 'Load This Folder as Playlist',
